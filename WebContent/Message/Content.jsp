...
<%
	...
	doctorDTO dto2 = dao2.getDoctor(id);
	
	
	messageDAO dao = new messageDAO() ;
	dao.readCheckCount("receiver") ;
	dao.getMessage(id, num); // 리턴값이 없다.
	messageDTO dto = dao.getContent(num) ;	
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        ...
        <%if(id != null){%>
        <i class="icofont-envelope"></i> <%=dto2.getName()%>님 안녕하세요.
        <%}%>
      </div>
    </div>
  </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <%if(id == null){%>
            <li><a href="/dogtor/Doctor/DoctorLogin.jsp">로그인</a></li>  
...
<center><div class="section-title"><h2>제목: <%=dto.getSubject() %></h2></div>

<table border = "1">
	<tr><td align="center" width="150" bgcolor="#e2eefd">보낸사람</td> <td align="center"> <%=dto.getWriter() %></td></tr>
	<tr><td align="center" width="150" bgcolor="#e2eefd">작성일</td> <td align="center"> <%=dto.getRe_date() %></td></tr>
	<tr><td align="center" width="150"  bgcolor="#e2eefd">내용</td> <td align="center" width="330"  colspan="10"><%=dto.getContent() %></td></tr>
</table>

<br />

<input type="button" value="삭제"  onclick="window.location='MessageDelete.jsp?num=<%=dto.getNum()%>'"/>
<input type="button" value="목록" onclick="location.href = document.referrer" />
<br />
