...
<center><b>글삭제</b>
<br>
<form method="POST" name="delForm"  action="freeDeletePro.jsp?pageNum=<%=pageNum%>" onsubmit="return deleteSave()"> 
		...
		<tr height="30">
 		...
 		<tr height="30">
    		<td align=center >
      			...
      			<input type="button" value="자유게시판 글목록" onclick="document.location.href='freeList.jsp?pageNum=<%=pageNum%>'">     
   			</td>
 		</tr>  
	</table> 
</form><br/><br/>
