...
<%
  ...
  Integer ref = Integer.parseInt(request.getParameter("ref")); //그룹번호
  Integer re_step = Integer.parseInt(request.getParameter("re_step")); //그룹내 게시순서
  Integer re_level = Integer.parseInt(request.getParameter("re_level")); //그룹내 댓글그룹
...
<script language="JavaScript">      
  function deleteSave(){	
	if(document.delForm.passwd.value==''){
		alert("비밀번호를 입력하십시요.");
		document.delForm.passwd.focus(); //focus()는 해당 위치에 커서 놔주는것.
		return false;
 	}
}    
  function focus(){
...
<form method="POST" name="delForm"  action="passwdPro.jsp" onsubmit="return deleteSave()"> 
	<table border="1" align="center" cellspacing="0" cellpadding="0" width="360">
		<tr height="30">
  		...
  		<tr height="30">
			<td align=center >
				비밀번호 : <input type="password" name="passwd" id="passwd" size="8" maxlength="12">
 		...
 		<tr height="30">
    		<td align=center >
      			...
      			<input type="button" value="글목록" onclick="document.location.href='list2.jsp?pageNum=<%=pageNum%>'">     
   			</td>
 		</tr>  
	</table> 
</form></center><br/><br/>
