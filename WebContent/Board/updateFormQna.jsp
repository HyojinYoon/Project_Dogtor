...
<form method="post" name="writeform" action="updateProQna.jsp?pageNum=<%=pageNum%>" onsubmit="return writeSave()">
<table width="400" border="1" cellspacing="0" cellpadding="0"   align="center">
  <tr>
    <td align="right" colspan="2" >
       <a href="list2.jsp?pageNum=<%=pageNum%>"> 문의게시판 글목록</a> 
    </td>
  </tr>
  <tr>
  ...
  <tr>      
   <td colspan=2  align="center"> 
     ...
     <input type="button" value="뒤로가기"  onclick="window.location='content.jsp?num=<%=num%>&pageNum=<%=pageNum%>'">
   </td>
 </tr>
 </table>
</form> <br/><br/>
