...
<center><b>글쓰기</b>
<br>
<form method="post" name="writeform" action="noticeWritePro.jsp" onsubmit="return writeSave()">
...
<td  width="330">
	<%=nick %></td>
	<input type="hidden" name="writer" value ="<%=nick%>"></td>
</tr>
<tr>
...
<tr>      
 <td colspan=2 align="center"> 
  ...
  <input type="button" value="목록보기" OnClick="window.location='noticeList.jsp'">
</td>
</tr>
</table>    
</form>
