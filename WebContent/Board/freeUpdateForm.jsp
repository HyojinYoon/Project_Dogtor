...
<%//세션검사 지우면 안됩니다. 헤더에서 사용중입니다. 만약 본인 내용에 세션 id 정검이 있을 경우 그 내용을 지워주세요.
	...
	DAO dao = new DAO();
	DTO dto = dao.updateGetArticle(num);
	if(!dto.getWriter().equals(nick)){%>
	<script>
...
<center><b>글수정</b>
<br>
<form method="post" name="writeform" action="freeUpdatePro.jsp?pageNum=<%=pageNum%>" onsubmit="return writeSave()" enctype="multipart/form-data">
<table width="400" border="1" cellspacing="0" cellpadding="0"   align="center">
  ...
  <tr>
    ...
    <td align="left" width="330" >
     ...
     <input type="hidden" name="save1" value="<%=article.getSave()%>" >
     <%if(article.getSave() != null){ %>
         현재 파일 : <%=article.getSave()%>
     <%}else{ %>
          현재 파일 : 등록되지 않았습니다.
     <%}%>
    </td>
  ...
  <tr>      
   <td colspan=2  align="center"> 
     ...
     <input type="button" value="뒤로가기"  onclick="window.location='freeContent.jsp?num=<%=num%>&pageNum=<%=pageNum%>'">
   </td>
 </tr>
 </table>
</form>
