...
<center><h2>글삭제 비밀번호 입력</h2>
</div>
<form method="POST" name="delForm"  action="noticeDeletePro.jsp?pageNum=<%=pageNum%>" onsubmit="return deleteSave()"> 
	<table border="1" align="center" cellspacing="0" cellpadding="0" width="360">
		<tr height="30">
     		<td align=center><b>"지금삭제하기"를 입력해주세요.</b></td>
  		</tr>
  		<tr height="30">
			<td align=center >
				입력하기 : <input type="text" name="passwd" size="8" maxlength="12">
 		...
 		<tr height="30">
    		<td align=center>
      			...
      			<input type="button" value="글목록" onclick="document.location.href='noticeList.jsp?pageNum=<%=pageNum%>'">     
   			</td>
 		</tr>  
	</table> 
</form>
