...
<head>
 ...
 <script type="text/javascript">
   function pageChangeMember()
   {	window.location = "/dogtor/Member/memberForm/adminMemberForm.jsp";	}
   
   function pageChangePet()
   {	 window.location = "/dogtor/Member/memberForm/adminPetForm.jsp";	}
</script>
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      ...
      <!-- 예약하기 버튼 -->
          ...
          <%}else{%>
                ...
                <%}%>
                <%if(status == 100){%>
                	<a href="/dogtor/Member/memberForm/mypageForm.jsp" class="btn-get-started scrollto"> 마이페이지 </a><p>&nbsp;</p>
                <%}%>
...
<input type="button" value="고객관리" onclick="pageChangeMember();" />
<input type="button" value="반려동물관리" onclick="pageChangePet();" />
</center>
<br /><br />
