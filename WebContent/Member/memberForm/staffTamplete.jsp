...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="#">STAFF.</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <%if(id == null){%>
            <li><a href="/dogtor/Doctor/DoctorHome.jsp">로그인</a></li>  
          ...
          <li class="drop-down"><a href="">쪽지확인</a>
            <ul>
          ...
          <li class="drop-down"><a href="">마이페이지</a>
            <ul>
              ...
              <li><a href="/dogtor/Doctor/DoctorHome.jsp">회원정보수정</a></li>
              <li><a href="/dogtor/Booking/doctorConfirmCalanderR.jsp">진료일정</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      ...
      <!-- 진료확인하기 버튼 -->
        <%if(id == null){%>
           <a href="#about" class="btn-get-started scrollto"> 진료일정 </a><p>&nbsp;</p>
           <br /> <a href="/dogtor/Doctor/DoctorHome.jsp" class="btn-get-started scrollto"> 로그인 </a><p>&nbsp;</p>
           <br /> <a href="/dogtor/Doctor/DocJoin.jsp" class="btn-get-started scrollto"> 회원가입 </a>
          <%}else{%>
               <a href="#about" class="btn-get-started scrollto"> 진료일정 </a><p>&nbsp;</p>
               <a href="#about" class="btn-get-started scrollto"> 로그아웃 </a>
             <%}%>  
      </div>
    </div>
  </section><!-- End Hero -->
