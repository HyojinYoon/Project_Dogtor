...
<h4><%=nick%>님 환영합니다 :)</h4>
	...
	<table align="center" border="2" cellpadding="0" cellspacing="10" width="150">
		𝗣𝗘𝗧 𝗜𝗡𝗙𝗢.
		<tr>
			<%
				...
				<%		PetDTO p_dto = new PetDTO();
						...
						<table align="center" border="1" cellpadding="0" cellspacing="10" width="150">
    						<tr><td align="center">이름 :</td>  <td align="center"><%=p_dto.getP_name() %></td></tr>
    						<tr><td align="center"> 생일 :</td> <td align="center"> <%=p_dto.getP_birth() %></td></tr>
    						<tr><td align="center"> 성별 :</td> <td align="center"> <%=p_dto.getP_gender() %></td></tr>			
    						<tr><td align="center">종류 : </td> <td align="center"> <%=p_dto.getP_kind() %></td> </tr>
    					</table>
    				</td>
    		  <%}%>
			</tr>
	...
	<br />
	<%if(status != 100)
	{%>	<input type="button" value="예약확인" onclick="window.location='/dogtor/Booking/reserveCheck.jsp'" /> <%}
	else
	{%>	<input type="button" value="회원관리" onclick="window.location='/dogtor/Member/memberForm/adminForm.jsp'" /> <%}
  	
  	if(id != null)
	{%>
		<input type="button" value="회원정보수정" onclick="window.location='/dogtor/Member/memberForm/update_PasswordForm.jsp'" />
		<input type="button" value="회원탈퇴" onclick="window.location='/dogtor/Member/memberForm/deleteForm.jsp'"/><br /><br />
