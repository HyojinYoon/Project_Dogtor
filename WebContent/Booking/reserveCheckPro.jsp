...
<%	
	...
	String email= id;
	//String email= "yangget@naver.com";//모두 연결시 삭제
	%>
...
<%//예약확인영역.(like 게시판)
    ...
    count = reserveDao.getReserveCount(email); // 이메일 기준으로 예약내역확이
...
<center><img src="/dogtor/save/findschedule.png" width="1500" /></center><br />	
