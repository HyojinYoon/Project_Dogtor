<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%if(id != null){%>
		<script>
			window.location="reserveCheckPro.jsp";
		</script>
...
<body>
  ...
  <!-- 여기에 본인 파트 시작 -->
	...
	<center><img src="/dogtor/save/mainlogo.png" width="400" /></center>
	<title>예약확인메인</title>
	<center>

	<form action="/dogtor/Member/memberPro/loginPro.jsp" method="post">
	...
	<br /><br />
	<form action="reserveCheckNonPro.jsp" method="post">
	<h3>아직 회원이 아니신가요?</h3><br />
		<input type="text" name="email" placeholder="이메일을 입력하세요" />
		<input type="text" name="reserve_date" placeholder="예약날짜를 입력하세요" /><br />
		<br />
		<b>*예약날짜 형식은 2021-5-12 와 같이 해주세요.</b>
		<br /><br />
		<input type="submit" value="비회원 예약확인" /> 
		<input type="button" value="메인페이지 가기" onclick="location.href = '/dogtor/Member/memberForm/dogtorHome.jsp';" />
		<input type="button" value="회원가입" onclick="location.href = '/dogtor/Member/memberForm/registerForm.jsp';" />
	</form>
	<br /><br />
</center>
