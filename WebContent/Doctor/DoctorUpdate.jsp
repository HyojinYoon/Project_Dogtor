        ...
        <%if(id == null){%>
          ...
          <%}else{%>
              <a href="/dogtor/Booking/doctorConfirmCalanderR.jsp" class="btn-get-started scrollto"> 진료일정 </a><p>&nbsp;</p>
               <a href="/dogtor/Doctor/DoctorUpdate.jsp" class="btn-get-started scrollto"> 정보수정 </a><p>&nbsp;</p>
               <a href="/dogtor/Message/Message.jsp" class="btn-get-started scrollto"> 메세지함 </a><p>&nbsp;</p>
               <a href="/dogtor/Member/memberForm/dogtorHome.jsp" class="btn-get-started scrollto"> DOGTOR </a><p>&nbsp;</p>
...
<br />	
<center><form name="join" action="/dogtor/Doctor/DoctorUpdatePro.jsp" method="post">
	...
	<%}else{%>
		<h4><b><%=dto.getName() %></b>님 정보를 수정해주세요. </h4>
		
		<table align="center" border="0" cellpadding="10" cellspacing="0" >
		  <tr height="60"><td align="left"><b>아이디</b></td>
		  <td> <%=dto.getId()%></td>
          <br /></tr>
   		<tr height="60">
    	<td align="left"><b>비밀번호</b></td>
    <td>
    <input type="password" name="pw" id="pw" value="<%=dto.getPw()%>" onchange="pw_Check()"/>&nbsp;<span id="check"></span></br>
    <font size= "1em">8~12글자/영문,숫자,특수문자(!,@,*) 조합</font></td>
    <br /></tr>
    <tr height="60">
    	<td align="left"><b>비밀번호 확인</b></td>
    <td>
    <input type="password" name="pwCheck" id="pwCheck" onchange="pw_Check()"/>&nbsp;<span id="same"></span>
    <br /></tr>
    	<tr height="60">
          ...
          <br /></tr>
   		<tr height="60">
    		...
    		<td><input type="text" name="birth" value="<%=dto.getBirth()%>" placeholder="ex.19950414" /></td>
          <tr height="60">
    		<td align="left"><b>휴대전화</b></td>
    	<td><input type="text" name="phone" value="<%=dto.getPhone()%>" placeholder="-빼고 입력하세요."/></td>
           <tr height="60">
           <br /></tr>
		...
		<input type="button" value="탈퇴하기" onclick="window.location='DocDelete.jsp'" />
