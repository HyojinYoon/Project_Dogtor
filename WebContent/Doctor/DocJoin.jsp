...
<%
	...
	function sub()
    {
    	...
    	var code = document.join.code.value;
    	if(!nick)
    	{
    		alert("코드를 입력하세요!");
    		return false;
...
<script type="text/javascript">
	...
	{
		var code=document.join.code.value;
		open("/dogtor/Doctor/DocCodeCheck.jsp?code="+encodeURI(code),"codeCheck","width=400,height=400");
	}
	
	function id_Check()
	{
		var id = document.join.id.value;
		open("/dogtor/Doctor/DocIdCheck.jsp?id="+id,"idCheck", "width=400,height=400");
	}
...
<body>
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
    <div class="container d-flex">
      <div class="contact-info mr-auto">
        ...
        <%if(id != null){%>
        <i class="icofont-envelope"></i> <%=dto.getId()%>님 안녕하세요.
        <%}%>
      </div>
    </div>
  </div>
  ...
  <!-- 여기에 본인 파트 시작 -->
    ...
    <h4>회원님 정보를 입력해주세요. </h4>
   
    <form name="join" action="/dogtor/Doctor/DocJoinPro.jsp" method="post" onsubmit="return sub();">
    <table align="center" border="0" cellpadding="10" cellspacing="0">
    <tr height="60">
    	<td align="left"><b>아이디</b></td>
    <td>
    <input type="text" name="id" style="width:150px;" />
    <input type="button" value="아이디중복확인" onclick="id_Check();" />&nbsp;<font size= "1em">영소문자, 숫자 조합 4~8자로 입력해주세요.</font></td>
    <br /></tr>
    <tr height="60">
    	<td align="left"><b>비밀번호</b></td>
    <td>
    <input type="password" name="pw" id="pw" onchange="pw_Check()"/><label id="check"></label><br/>
    <font size= "1em">8~12글자/영문,숫자,특수문자(!,@,*) 조합</font></td>
    <br /></tr>
    <tr height="60">
    	<td align="left"><b>비밀번호 확인</b></td>
    <td>
    <input type="password" name="pwCheck" id="pwCheck" onchange="pw_Check()"/><label id="same"></label>
    <br /></tr>
    <tr height="60">
    ...
    <td>	
    	<input type="text" name="birth" placeholder="ex.19950414" /></td>
    <br /></tr>
    <tr height="60">
   		<td align="left"><b>CODE</b></td>
   		<td>
    <input type="text" name="code" />
    <input type="button" value="중복확인" onclick="code_Check();" />&nbsp;<font size= "1em">영어 소문자 한글자를 입력해주세요. (변경 불가능)</font></td>
    <label id="coderesult"></label>
    <br /></tr>
    <tr height="60">
    		<td align="left"><b>휴대전화</b></td>
    <td>
    <input type="text" name="phone" placeholder="-빼고 입력하세요."/></td>
    <br />
     </table>
