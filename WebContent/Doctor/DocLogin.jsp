...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
  	...
  	<form action="/dogtor/Doctor/DocLoginPro.jsp" method="post">
		
		<b>ID</b> : <input type="text" name="id" /> &nbsp;&nbsp;
		<b>PW</b> : <input type="password" name="pw" />&nbsp;&nbsp;&nbsp;
		
		 	<input type="submit" value="로그인" class="btn-get-started scrollto"><br />
           ...
           <div class="d-flex">
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           <a href="/dogtor/Doctor/DocJoin.jsp" class="btn-get-started scrollto"> 회원가입 </a><p>&nbsp;</p>
           <a href="javascript:void(window.open('/dogtor/Doctor/DocIdSearch.jsp',width=100, heigh=100))" class="btn-get-started scrollto"> ID 찾기 </a><p>&nbsp;</p>
           <a href="javascript:void(window.open('/dogtor/Doctor/DocPwSearch.jsp',width=100, heigh=100))" class="btn-get-started scrollto"> PW 찾기 </a>
          
          <%}else{%>
              <br /> <a href="/dogtor/Booking/doctorConfirmCalanderR.jsp" class="btn-get-started scrollto"> 진료일정 </a><p>&nbsp;</p>
